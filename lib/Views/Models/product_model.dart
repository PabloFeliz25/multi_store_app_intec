...
class ProductModel {
  ...
  ProductModel({
    ...
    this.isFavorite = false, // Inicializa como false por defecto
  });
  ...
  factory ProductModel.fromDocument(DocumentSnapshot doc) {
    ...
    return ProductModel(
      ...
      isFavorite: data['isFavorite'] ?? false, // Lee el valor de isFavorite
    );
  }
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'size': size,
      'images': images,
      'isFavorite': isFavorite, // Incluye isFavorite en el mapa
    };
  }
}
